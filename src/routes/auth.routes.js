...
router.post('/send-otp', otpRateLimiter, validateBody(sendOtpSchema), sendOtpHandler);
router.post('/resend-otp', otpRateLimiter, validateBody(sendOtpSchema), sendOtpHandler);
