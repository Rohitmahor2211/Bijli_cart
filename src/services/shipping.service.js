...
export const checkServiceability = async ({ pickupPincode, deliveryPincode, paymentMethod = 'Prepaid', packageDetails = null }) => {
  ...
  if (isMockShippingMode()) return { serviceable: true, estimatedCharge: 0, courierOptions: [{ courierId: 'mock_standard', courierName: 'bijliKart Test Logistics', rate: 0, estimatedDeliveryDays: 3 }], package: pkg };
