...
app.post('/api/payment-webhooks/razorpay', express.raw({ type: 'application/json' }), razorpayWebhook);
...
app.use((req, res) => {
  return sendError(res, `Cannot ${req.method} ${req.originalUrl} - Endpoint not found`, null, 404);
});
