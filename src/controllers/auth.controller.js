...
export const login = asyncWrapper(async (req, res) => {
  ...
  // Generate and send OTP for 2-Factor authentication requirement
  ...
  return sendSuccess(res, 'Password verified. OTP sent to your registered phone number for verification.', {
    phone,
    requiresOtp: true,
